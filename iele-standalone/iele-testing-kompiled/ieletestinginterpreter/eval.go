...
func Eval(c m.K, config m.K) (m.K, error) {
	...
	switch kapp.Label {
		...
		case m.LblXhashloadKeysXuIELEXhyphenTESTING:
			if len(kapp.List) != 0 {
				return m.NoResult, &evalArityViolatedError{funcName:"evalXhashloadKeysXuIELEXhyphenTESTING", expectedArity: 0, actualArity: len(kapp.List)}
			}
			return evalXhashloadKeysXuIELEXhyphenTESTING(config, -1)
		...
		case m.LblXhashpostKeysXuIELEXhyphenTESTING:
			if len(kapp.List) != 0 {
				return m.NoResult, &evalArityViolatedError{funcName:"evalXhashpostKeysXuIELEXhyphenTESTING", expectedArity: 0, actualArity: len(kapp.List)}
			}
			return evalXhashpostKeysXuIELEXhyphenTESTING(config, -1)
		...
		case m.LblXhashsortJSONListAux:
			if len(kapp.List) != 2 {
				return m.NoResult, &evalArityViolatedError{funcName:"evalXhashsortJSONListAux", expectedArity: 2, actualArity: len(kapp.List)}
			}
			return evalXhashsortJSONListAux(kapp.List[0], kapp.List[1], config, -1)
		...
		case m.LblXhashtoInts:
			if len(kapp.List) != 1 {
				return m.NoResult, &evalArityViolatedError{funcName:"evalXhashtoInts", expectedArity: 1, actualArity: len(kapp.List)}
			}
			return evalXhashtoInts(kapp.List[0], config, -1)
		...
		case m.LblXhashrlpEncodeLogsAux:
			if len(kapp.List) != 1 {
				return m.NoResult, &evalArityViolatedError{funcName:"evalXhashrlpEncodeLogsAux", expectedArity: 1, actualArity: len(kapp.List)}
			}
			return evalXhashrlpEncodeLogsAux(kapp.List[0], config, -1)
		...
		case m.LblXhashisSorted:
			if len(kapp.List) != 1 {
				return m.NoResult, &evalArityViolatedError{funcName:"evalXhashisSorted", expectedArity: 1, actualArity: len(kapp.List)}
			}
			return evalXhashisSorted(kapp.List[0], config, -1)
		...
		case m.LblXhashexecKeysXuIELEXhyphenTESTING:
			if len(kapp.List) != 0 {
				return m.NoResult, &evalArityViolatedError{funcName:"evalXhashexecKeysXuIELEXhyphenTESTING", expectedArity: 0, actualArity: len(kapp.List)}
			}
			return evalXhashexecKeysXuIELEXhyphenTESTING(config, -1)
		...
		case m.LblXhashinsertJSONKey:
			if len(kapp.List) != 2 {
				return m.NoResult, &evalArityViolatedError{funcName:"evalXhashinsertJSONKey", expectedArity: 2, actualArity: len(kapp.List)}
			}
			return evalXhashinsertJSONKey(kapp.List[0], kapp.List[1], config, -1)
		case m.LblIsQuadOp:
			if len(kapp.List) != 1 {
		...
		case m.LblXhashasScheduleString:
			if len(kapp.List) != 1 {
				return m.NoResult, &evalArityViolatedError{funcName:"evalXhashasScheduleString", expectedArity: 1, actualArity: len(kapp.List)}
			}
			return evalXhashasScheduleString(kapp.List[0], config, -1)
		...
		case m.LblXhashhasPostXquesXlparenXuXrparenXuIELEXhyphenTESTING:
			if len(kapp.List) != 1 {
				return m.NoResult, &evalArityViolatedError{funcName:"evalXhashhasPostXquesXlparenXuXrparenXuIELEXhyphenTESTING", expectedArity: 1, actualArity: len(kapp.List)}
			}
			return evalXhashhasPostXquesXlparenXuXrparenXuIELEXhyphenTESTING(kapp.List[0], config, -1)
		...
		case m.LblXhashrlpEncodeLogs:
			if len(kapp.List) != 1 {
				return m.NoResult, &evalArityViolatedError{funcName:"evalXhashrlpEncodeLogs", expectedArity: 1, actualArity: len(kapp.List)}
			}
			return evalXhashrlpEncodeLogs(kapp.List[0], config, -1)
		...
		case m.LblXhashsortJSONList:
			if len(kapp.List) != 1 {
				return m.NoResult, &evalArityViolatedError{funcName:"evalXhashsortJSONList", expectedArity: 1, actualArity: len(kapp.List)}
			}
			return evalXhashsortJSONList(kapp.List[0], config, -1)
		case m.LblXhashrlpEncodeTopics:
			if len(kapp.List) != 1 {
				return m.NoResult, &evalArityViolatedError{funcName:"evalXhashrlpEncodeTopics", expectedArity: 1, actualArity: len(kapp.List)}
			}
			return evalXhashrlpEncodeTopics(kapp.List[0], config, -1)
		case m.LblXuMapXu:
			if len(kapp.List) != 2 {
		...
		case m.LblXhashlambdaXuXu3:
			if len(kapp.List) != 14 {
				return m.NoResult, &evalArityViolatedError{funcName:"evalXhashlambdaXuXu3", expectedArity: 14, actualArity: len(kapp.List)}
			}
			return evalXhashlambdaXuXu3(kapp.List[0], kapp.List[1], kapp.List[2], kapp.List[3], kapp.List[4], kapp.List[5], kapp.List[6], kapp.List[7], kapp.List[8], kapp.List[9], kapp.List[10], kapp.List[11], kapp.List[12], kapp.List[13], config, -1)
		...
		case m.LblXhashallPostKeysXuIELEXhyphenTESTING:
			if len(kapp.List) != 0 {
				return m.NoResult, &evalArityViolatedError{funcName:"evalXhashallPostKeysXuIELEXhyphenTESTING", expectedArity: 0, actualArity: len(kapp.List)}
			}
			return evalXhashallPostKeysXuIELEXhyphenTESTING(config, -1)
		...
		case m.LblXhashdiscardKeysXuIELEXhyphenTESTING:
			if len(kapp.List) != 0 {
				return m.NoResult, &evalArityViolatedError{funcName:"evalXhashdiscardKeysXuIELEXhyphenTESTING", expectedArity: 0, actualArity: len(kapp.List)}
			}
			return evalXhashdiscardKeysXuIELEXhyphenTESTING(config, -1)
		...
		case m.LblXhashcheckKeysXuIELEXhyphenTESTING:
			if len(kapp.List) != 0 {
				return m.NoResult, &evalArityViolatedError{funcName:"evalXhashcheckKeysXuIELEXhyphenTESTING", expectedArity: 0, actualArity: len(kapp.List)}
			}
			return evalXhashcheckKeysXuIELEXhyphenTESTING(config, -1)
		case m.LblIsInts:
			if len(kapp.List) != 1 {
		...
		case m.LblXhashblockhash:
			if len(kapp.List) != 4 {
				return m.NoResult, &evalArityViolatedError{funcName:"evalXhashblockhash", expectedArity: 4, actualArity: len(kapp.List)}
			}
			return evalXhashblockhash(kapp.List[0], kapp.List[1], kapp.List[2], kapp.List[3], config, -1)
