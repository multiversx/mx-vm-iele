...
func main() {
	hookPackages := "github.com/ElrondNetwork/elrond-vm/iele-standalone/hookadapter/krypto"
	...
	cmd.Dir = path.Join(build.Default.GOPATH, "src/github.com/ElrondNetwork/elrond-vm/iele-standalone")
