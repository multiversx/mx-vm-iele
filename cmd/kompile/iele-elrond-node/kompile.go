...
func main() {
	hookPackages := "github.com/ElrondNetwork/elrond-vm/iele/elrond/node/hookadapter/krypto " +
	...
	cmd.Dir = path.Join(build.Default.GOPATH, "src/github.com/ElrondNetwork/elrond-vm/iele/elrond/node")
