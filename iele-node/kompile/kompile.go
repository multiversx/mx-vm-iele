...
func main() {
	hookPackages := "github.com/ElrondNetwork/elrond-vm/iele-node/hookadapter/krypto " +
		"github.com/ElrondNetwork/elrond-vm/iele-node/hookadapter/blockchain"
	...
	cmd.Dir = path.Join(build.Default.GOPATH, "src/github.com/ElrondNetwork/elrond-vm/iele-node")
