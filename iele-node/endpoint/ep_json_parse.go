...
func processTest(testObj interface{}) (*test, error) {
	...
	test := &test{pre: eh.MakeAccountMap(), postState: eh.MakeAccountMap()}
	...
	var bhsOk bool
	test.blockHashes, bhsOk = processStringList(testMap["blockhashes"])
	if !bhsOk {
