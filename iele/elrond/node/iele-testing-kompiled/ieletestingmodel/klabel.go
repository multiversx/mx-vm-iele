...
func (kl KLabel) Name () string {
	switch kl {
		...
		case LblELRONDTESTNETXuIELEXhyphenCONSTANTS:
			return "ELRONDTESTNET_IELE-CONSTANTS"
...
func ParseKLabel (name string) KLabel {
	switch name {
		...
		case "ELRONDTESTNET_IELE-CONSTANTS":
			return LblELRONDTESTNETXuIELEXhyphenCONSTANTS
		case "<exists>":
