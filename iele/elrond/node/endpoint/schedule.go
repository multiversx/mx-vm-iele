...
func (ElrondIeleVMType) ParseSchedule(scheduleName string) (vmi.Schedule, error) {
	switch scheduleName {
	case "Default":
...
func (ElrondIeleVMType) G0(schedule vmi.Schedule, txCreate bool, dataForGas string, args []*big.Int) (*big.Int, error) {
