...
func (i *Interpreter) Eval(c m.KReference, config m.KReference) (m.KReference, error) {
	kapp, isKapply := i.Model.GetKApplyObject(c)
	if !isKapply {
		return c, nil
	}
	switch kapp.Label {
		...
		case m.LblXhashloadKeysXuIELEXhyphenTESTING:
			...
			return i.evalXhashloadKeysXuIELEXhyphenTESTING(config, -1)
		...
		case m.LblXhashpostKeysXuIELEXhyphenTESTING:
			...
			return i.evalXhashpostKeysXuIELEXhyphenTESTING(config, -1)
		...
		case m.LblXhashsortJSONListAux:
			...
			return i.evalXhashsortJSONListAux(kapp.List[0], kapp.List[1], config, -1)
		...
		case m.LblXhashtoInts:
			...
			return i.evalXhashtoInts(kapp.List[0], config, -1)
		...
		case m.LblXhashrlpEncodeLogsAux:
			...
			return i.evalXhashrlpEncodeLogsAux(kapp.List[0], config, -1)
		...
		case m.LblXhashisSorted:
			...
			return i.evalXhashisSorted(kapp.List[0], config, -1)
		...
		case m.LblXhashexecKeysXuIELEXhyphenTESTING:
			...
			return i.evalXhashexecKeysXuIELEXhyphenTESTING(config, -1)
		...
		case m.LblXhashinsertJSONKey:
			...
			return i.evalXhashinsertJSONKey(kapp.List[0], kapp.List[1], config, -1)
		case m.LblIsQuadOp:
			if len(kapp.List) != 1 {
		...
		case m.LblXhashasScheduleString:
			...
			return i.evalXhashasScheduleString(kapp.List[0], config, -1)
		...
		case m.LblXhashhasPostXquesXlparenXuXrparenXuIELEXhyphenTESTING:
			...
			return i.evalXhashhasPostXquesXlparenXuXrparenXuIELEXhyphenTESTING(kapp.List[0], config, -1)
		...
		case m.LblXhashrlpEncodeLogs:
			...
			return i.evalXhashrlpEncodeLogs(kapp.List[0], config, -1)
		...
		case m.LblXhashsortJSONList:
			...
			return i.evalXhashsortJSONList(kapp.List[0], config, -1)
		case m.LblXhashrlpEncodeTopics:
			...
			return i.evalXhashrlpEncodeTopics(kapp.List[0], config, -1)
		case m.LblXuMapXu:
			if len(kapp.List) != 2 {
		...
		case m.LblXhashlambdaXuXu3:
			...
			return i.evalXhashlambdaXuXu3(kapp.List[0], kapp.List[1], kapp.List[2], kapp.List[3], kapp.List[4], kapp.List[5], kapp.List[6], kapp.List[7], kapp.List[8], kapp.List[9], kapp.List[10], kapp.List[11], kapp.List[12], kapp.List[13], config, -1)
		...
		case m.LblXhashallPostKeysXuIELEXhyphenTESTING:
			...
			return i.evalXhashallPostKeysXuIELEXhyphenTESTING(config, -1)
		...
		case m.LblXhashdiscardKeysXuIELEXhyphenTESTING:
			...
			return i.evalXhashdiscardKeysXuIELEXhyphenTESTING(config, -1)
		...
		case m.LblXhashcheckKeysXuIELEXhyphenTESTING:
			...
			return i.evalXhashcheckKeysXuIELEXhyphenTESTING(config, -1)
		case m.LblIsInts:
			if len(kapp.List) != 1 {
		...
		case m.LblXhashblockhash:
			...
			return i.evalXhashblockhash(kapp.List[0], kapp.List[1], kapp.List[2], kapp.List[3], config, -1)
